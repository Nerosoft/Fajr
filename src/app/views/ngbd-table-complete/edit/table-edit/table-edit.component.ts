  ...
  static setupTableEditComponent(Id, nameId, ID, callback) {
    ...
    if (Id == "ClientsComponent") {
      ...
      TableEditComponent.callback.push((modalN, toastService) => {
        ...
        toastService.show(HeroService.message.success.plus, 
    ...
    else if (Id == "BranchComponent") {
      TableEditComponent.Id = Id;
      TableEditComponent.nameId = nameId;
      let reaArraylindex = TableEditComponent.indexArray(HeroService.Branch, ID)

      TableEditComponent.model = Branch.setBranch();
      TableEditComponent.err = HeroService.err.Branch;

      TableEditComponent.model.branchName = HeroService.Branch[reaArraylindex].branchName
      TableEditComponent.model.name = HeroService.Branch[reaArraylindex].name
      TableEditComponent.model.pass = HeroService.Branch[reaArraylindex].pass
      TableEditComponent.model.phone = HeroService.Branch[reaArraylindex].phone
      TableEditComponent.model.address = HeroService.Branch[reaArraylindex].address

      TableEditComponent.callback.push((modalN, toastService) => {
        HeroService.Branch[reaArraylindex].branchName = TableEditComponent.model.branchName;
        HeroService.Branch[reaArraylindex].name = TableEditComponent.model.name;
        HeroService.Branch[reaArraylindex].pass = TableEditComponent.model.pass;
        HeroService.Branch[reaArraylindex].phone = TableEditComponent.model.phone;
        HeroService.Branch[reaArraylindex].address = TableEditComponent.model.address;
        HeroService.nvCategorysServes.updateF(HeroService.Branch[reaArraylindex].key, HeroService.Branch[reaArraylindex])
      ...
      //-----------remove----------
      TableEditComponent.callback.push((_modalService) => {
        NgbdModalConfirmAutofocusComponent.setupRemoveBranchsComponent(() => {
          console.log("after delete " + reaArraylindex);
          HeroService.nvCategorysServes.deleteF(HeroService.Branch[reaArraylindex].key);
          HeroService.Branch = TableEditComponent.removeItemOnce(HeroService.Branch,
            HeroService.Branch[reaArraylindex]);
          console.log("delete", HeroService.Branch)
          callback();
        }, TableEditComponent.model.name);
        _modalService.open(NgbdModalConfirmAutofocusComponent);
      })
